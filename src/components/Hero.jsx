  ...
  return (
    <section className="h-screen flex items-center justify-center px-4 sm:px-6 md:px-8 pb-20 relative overflow-hidden bg-primary">
      ...
      <div className="text-center max-w-7xl mx-auto relative z-10">
        ...
        <motion.h1 
          className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-white mb-6 leading-tight tracking-tight"
        ...
        >
          <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-white font-bold mb-3 leading-tight">
            Digital Solutions Without Barriers
          </p>
          
          <p className="text-base sm:text-lg md:text-xl text-white/80 mb-12 max-w-4xl mx-auto font-light">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative px-8 py-4 bg-white text-primary-dark rounded-lg font-bold overflow-hidden transition-all duration-300 flex items-center gap-3"
          >
          ...
          <motion.a 
            ...
            whileTap={{ scale: 0.98 }}
            className="group px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-bold transition-all duration-300 flex items-center gap-3 hover:text-primary-dark"
          >
      ...
      <motion.button
        onClick={scrollToProduct}
        className="absolute bottom-12 left-1/2 -translate-x-1/2 cursor-pointer bg-transparent border-none outline-none z-20"
        animate={{ y: [0, 10, 0] }}
        transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
        whileHover={{ scale: 1.2 }}
        whileTap={{ scale: 0.9 }}
      >
        <svg className="w-8 h-8 text-white hover:text-white/90 transition-colors drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
